      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gray-900">
        ...
        <div className="absolute bottom-16 left-12 text-white pr-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <h1 className="text-4xl xl:text-5xl font-extrabold mb-4 tracking-tight">
            Discover Your <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">Signature Look.</span>
          </h1>
          <p className="text-lg text-gray-300 font-medium">
            Create an account to unlock exclusive collections, personalized recommendations, and a seamless checkout experience.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white/70 backdrop-blur-2xl border border-white/60 shadow-2xl shadow-purple-200/40 rounded-[2rem] p-6 sm:p-10 w-full max-w-[420px] relative z-10 animate-in fade-in zoom-in duration-500">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-gray-500 text-sm font-medium">
              Join <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 font-bold">Fashion City</span> today
            </p>
          </div>
          ...
          <form className="flex flex-col gap-3.5" onSubmit={handleSubmit}>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-white/60 border border-white/80 pl-11 pr-4 py-3 rounded-[1rem] focus:outline-none focus:ring-2 focus:ring-pink-300 focus:bg-white transition-all shadow-sm placeholder-gray-400 text-gray-700 font-medium text-sm sm:text-base"
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-white/60 border border-white/80 pl-11 pr-12 py-3 rounded-[1rem] focus:outline-none focus:ring-2 focus:ring-teal-300 focus:bg-white transition-all shadow-sm placeholder-gray-400 text-gray-700 font-medium text-sm sm:text-base"
          ...
          <p className="text-center text-xs sm:text-sm text-gray-500 mt-6 font-medium">
            ...
            <Link to="/auth/login" className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 font-extrabold ml-1.5 hover:underline decoration-pink-400 underline-offset-4 transition-all">
              Login
            </Link>
          </p>
